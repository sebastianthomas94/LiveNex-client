...
export default function SideBar() {
    return (
        ...
        <ul>
          <li className="mb-2">
            <Link to="/dashboard" className="flex items-center text-gray-600 hover:text-gray-800 font-normal text-lg leading-6">
              <svg
          ...
          <li className="mb-2">
            <Link to="#" className="flex items-center text-gray-600 hover:text-gray-800 font-normal text-lg leading-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8 mr-3 text-gray-600 hover:text-gray-800"
                fill="none"
          ...
          <li className="mb-2">
            <Link to="/destinations" className="flex items-center text-gray-600 hover:text-gray-800 font-normal text-lg leading-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8 mr-3 text-gray-600 hover:text-gray-800"
                fill="none"
